package com.faurecia.westworks.omega.gmLanController 
{
	 ...
	 * @author jimF
	 */
	public class OmegaWiFiSeatController extends MovieClip 
	{
		...
		public function OmegaWiFiSeatController() 
		{
			...
			stage.addEventListener("UPDATE_TARGET_SEAT", updateTargetSeatEvent);
						
			controlModeTxt.text = "";
			controlModeTxt.visible = false;
		}
		
		private function updateTargetSeatEvent(e:DataEvent):void 
		{
			trace(e.data);
			if (e.data == "driver"){
				connectionPanel.targetSeatId = OmegaControlStrings.OMEGA_HEADER_DRIVER;
			}
			if (e.data == "passenger"){
				connectionPanel.targetSeatId = OmegaControlStrings.OMEGA_HEADER_PASSENGER;
			}
		}
		...
		private function setUpButtonModes():void 
		{
			...
			touchPanel.controlMode1Txt.text = "Upper Back Angle";
